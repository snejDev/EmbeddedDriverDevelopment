...
#define SPI1				((SPI_RegDef_t*)SPI1_BASEADDR)		//Storing Typecasted base address of SPI1 Base address
#define SPI2				((SPI_RegDef_t*)SPI2_BASEADDR)		//Storing Typecasted base address of SPI2 Base address
#define SPI3				((SPI_RegDef_t*)SPI3_BASEADDR)		//Storing Typecasted base address of SPI3 Base address
...
#define SPI1_PCLK_EN()		(RCCCLK->APB2ENR |= (1<<12))
#define SPI2_PCLK_EN()		(RCCCLK->APB1ENR |= (1<<14))
#define SPI3_PCLK_EN()		(RCCCLK->APB1ENR |= (1<<15))
#define SPI1_PCLK_DI()		(RCCCLK->APB2ENR &= ~(1<<12))
#define SPI2_PCLK_DI()		(RCCCLK->APB1ENR &= ~(1<<14))
#define SPI3_PCLK_DI()		(RCCCLK->APB1ENR &= ~(1<<15))
/***Peripheral clocks enable and disable***/
